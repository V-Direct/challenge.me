...
export default function Profile({
  ...
  return (
    <div className="Profile">
      ...
      />
      <ProfileLabel
        divClassname="LabelMarg"
        className="ProfLabel"
        content={
          <div>
            Profile <img className="labelIcons" alt="profile" src={logo2}></img>
          </div>
        }
        link="login"
      ></ProfileLabel>
      <ProfileLabel
        ...
        content={
          <div>
            Settings{" "}
            <img className="labelIconsSetting" alt="profile" src={logo5}></img>
          </div>
        }
        link="login"
      ></ProfileLabel>
      <ProfileLabel
        ...
        content={
          <div>
            More <img className="labelIconsDot" alt="profile" src={logo3}></img>
          </div>
        }
        link="contact"
      ></ProfileLabel>
      <ProfileLabel
        ...
        content={
          <div>
            Logout{" "}
            <img className="labelIconsLogout" alt="profile" src={logo4}></img>
          </div>
        }
        link="logout"
      ></ProfileLabel>
